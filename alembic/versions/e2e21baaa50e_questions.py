...
Revision ID: e2e21baaa50e
Revises: 90232f2854f1
Create Date: 2024-10-05 14:37:05.090532
...
def upgrade() -> None:
    ...
    op.add_column('chats', sa.Column('questions', sa.ARRAY(sa.Text()), nullable=False))
